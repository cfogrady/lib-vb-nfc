...
class VBNfcDataTranslator : NfcDataTranslator {
    ...
    override fun parseHeader(headerBytes: ByteArray): NfcHeader {
        val header = VBNfcHeader(
            deviceType = DeviceType.VitalSeries,
            deviceSubType = NfcHeader.DeviceSubType.fromSubTypeId(headerBytes.getUInt16(6)),
