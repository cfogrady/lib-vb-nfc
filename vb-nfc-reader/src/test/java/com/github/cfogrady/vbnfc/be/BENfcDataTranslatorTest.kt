...
class BENfcDataTranslatorTest {
    ...
    fun testNfcCharacterFormatting() {
        ...
        assertAllBlocksAreEqual("Data Set", expectedCharacterInByteArray, resultArray)
        ...
        assertAllBlocksAreEqual("Finalized Data", expectedFinalizedByteArray, resultArray)
    }
    ...
    fun assertAllBlocksAreEqual(msg: String = "", expected: ByteArray, actual: ByteArray) {
        ...
        for(i in 0..<actual.size step blockSize) {
            val block = i/16
